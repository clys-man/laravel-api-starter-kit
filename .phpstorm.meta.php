...
'filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','horizon.domain','horizon.path','horizon.use',
...
'horizon.jobs.show','horizon.index','pulse','sanctum.csrf-cookie','telescope','livewire.update','livewire.upload-file','livewire.preview-file','auth:login','auth:register',
'auth:logout','users:index','users:show','users:update','users:destroy','storage.local',);
...
'pulse::livewire.slow-requests','pulse::livewire.usage','scribe::components.badges.auth','scribe::components.badges.base','scribe::components.badges.http-method',
'scribe::components.field-details','scribe::components.nested-fields','scribe::external.elements','scribe::external.rapidoc','scribe::external.scalar',
'scribe::markdown.auth','scribe::markdown.intro','scribe::partials.example-requests.bash.md','scribe::partials.example-requests.javascript.md','scribe::partials.example-requests.php.md',
'scribe::partials.example-requests.python.md','scribe::themes.default.endpoint','scribe::themes.default.groups','scribe::themes.default.index','scribe::themes.default.sidebar',
'scribe::themes.elements.components.field-details','scribe::themes.elements.components.nested-fields','scribe::themes.elements.endpoint','scribe::themes.elements.groups','scribe::themes.elements.index',
'scribe::themes.elements.sidebar','scribe::themes.elements.try_it_out','telescope::layout',);
