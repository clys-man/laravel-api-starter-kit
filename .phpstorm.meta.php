...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Repositories\User\UserRepositoryInterface' => \App\Repositories\User\EloquentUserRepository::class,
            'App\Services\Auth\AuthServiceInterface' => \App\Services\Auth\AuthService::class,
            'App\Services\User\UserServiceInterface' => \App\Services\User\UserService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dev/Projects/logaroo/paybufo-api/public/storage' => 'string',
            'horizon.name' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/dev/Projects/logaroo/paybufo-api/public/storage','horizon.name','horizon.domain','horizon.path',
...
'horizon.environments.local.supervisor-1.maxProcesses','insights.preset','insights.ide','insights.exclude','insights.add.NunoMaduro\\PhpInsights\\Domain\\Metrics\\Architecture\\Classes',
'insights.remove','insights.config.NunoMaduro\\PhpInsights\\Domain\\Insights\\ForbiddenPrivateMethods.title','insights.requirements.min-quality','insights.requirements.min-complexity','insights.requirements.min-architecture',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','scribe.title','scribe.description','scribe.intro_text',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','octane.server','octane.https','octane.listeners.Laravel\\Octane\\Events\\WorkerStarting','octane.listeners.Laravel\\Octane\\Events\\RequestReceived',
...
'octane.watch','octane.garbage','octane.max_execution_time','livewire.class_namespace','livewire.view_path',
...
'signed','throttle','verified','basic',);
...
'horizon.jobs.show','horizon.index','pulse','sanctum.csrf-cookie','telescope','livewire.update','livewire.upload-file','livewire.preview-file','auth:login',
'auth:register','auth:logout','users:index','users:show','users:update',
'users:destroy','storage.local',);
        registerArgumentsSet('views', 
'pulse::dashboard','scribe.index','vendor.pulse.dashboard','welcome','7224ff0b1fa42156c352216deff15b56::card',
...
'pulse::livewire.slow-requests','pulse::livewire.usage','scribe::components.badges.auth','scribe::components.badges.base','scribe::components.badges.deprecated',
